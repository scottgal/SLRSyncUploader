...
namespace NetSync
{
    ...
    public class IOStream
    {
        ...
        private byte[] IOBufIn;
        private int IOBufInIndex;
        private int IOBufInSize;
        private byte[] IOBufOut;
        private int IOBufOutCount;
        private bool IOMultiplexingIn;
        private bool IOMultiplexingOut;

        /// <summary>
        /// False
        /// </summary>
        private bool noFlush;
