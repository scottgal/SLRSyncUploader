...
namespace NetSync
{
    public class MainClass
    {
        ...
        public void Run(string[] args)
        {
            ...
            var cInfo = new ClientInfo {Options = Opt};
        ...
        public static int StartInbandExchange(string user, string path, ClientInfo cInfo, int argc)
        {
            ...
            var sargs = new string[Options.MAX_ARGS];
        ...
        public static void SetupProtocol(ClientInfo cInfo)
        {
            ...
            if (options.remoteProtocol < Options.MIN_PROTOCOL_VERSION ||
                options.remoteProtocol > Options.MAX_PROTOCOL_VERSION)
            {
   ...
   Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA");
        ...
        public static void Usage()
        {
            ...
            Log.WriteLine("     --suffix=SUFFIX         backup suffix (default " + BackupSuffix + " w/o --backup-dir)");
